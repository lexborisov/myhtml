...
enum mytags_tag {
	...
	MyTAGS_TAG_MAP            = 0x053,
	MyTAGS_TAG_MARK           = 0x054,
	MyTAGS_TAG_MARQUEE        = 0x055,
	MyTAGS_TAG_MATH           = 0x056,
	MyTAGS_TAG_MENU           = 0x057,
	MyTAGS_TAG_MENUITEM       = 0x058,
	MyTAGS_TAG_MERROR         = 0x059,
	MyTAGS_TAG_META           = 0x05a,
	MyTAGS_TAG_METER          = 0x05b,
	MyTAGS_TAG_MI             = 0x05c,
	MyTAGS_TAG_MO             = 0x05d,
	MyTAGS_TAG_MN             = 0x05e,
	MyTAGS_TAG_MS             = 0x05f,
	MyTAGS_TAG_MTEXT          = 0x060,
	MyTAGS_TAG_NAV            = 0x061,
	MyTAGS_TAG_NOBR           = 0x062,
	MyTAGS_TAG_NOEMBED        = 0x063,
	MyTAGS_TAG_NOFRAMES       = 0x064,
	MyTAGS_TAG_NOSCRIPT       = 0x065,
	MyTAGS_TAG_OBJECT         = 0x066,
	MyTAGS_TAG_OL             = 0x067,
	MyTAGS_TAG_OPTGROUP       = 0x068,
	MyTAGS_TAG_OPTION         = 0x069,
	MyTAGS_TAG_OUTPUT         = 0x06a,
	MyTAGS_TAG_P              = 0x06b,
	MyTAGS_TAG_PARAM          = 0x06c,
	MyTAGS_TAG_PLAINTEXT      = 0x06d,
	MyTAGS_TAG_PRE            = 0x06e,
	MyTAGS_TAG_PROGRESS       = 0x06f,
	MyTAGS_TAG_Q              = 0x070,
	MyTAGS_TAG_RB             = 0x071,
	MyTAGS_TAG_RP             = 0x072,
	MyTAGS_TAG_RT             = 0x073,
	MyTAGS_TAG_RTC            = 0x074,
	MyTAGS_TAG_RUBY           = 0x075,
	MyTAGS_TAG_S              = 0x076,
	MyTAGS_TAG_SAMP           = 0x077,
	MyTAGS_TAG_SCRIPT         = 0x078,
	MyTAGS_TAG_SECTION        = 0x079,
	MyTAGS_TAG_SELECT         = 0x07a,
	MyTAGS_TAG_SMALL          = 0x07b,
	MyTAGS_TAG_SOURCE         = 0x07c,
	MyTAGS_TAG_SPAN           = 0x07d,
	MyTAGS_TAG_STRIKE         = 0x07e,
	MyTAGS_TAG_STRONG         = 0x07f,
	MyTAGS_TAG_STYLE          = 0x080,
	MyTAGS_TAG_SUB            = 0x081,
	MyTAGS_TAG_SUMMARY        = 0x082,
	MyTAGS_TAG_SUP            = 0x083,
	MyTAGS_TAG_SVG            = 0x084,
	MyTAGS_TAG_TABLE          = 0x085,
	MyTAGS_TAG_TBODY          = 0x086,
	MyTAGS_TAG_TD             = 0x087,
	MyTAGS_TAG_TEMPLATE       = 0x088,
	MyTAGS_TAG_TEXTAREA       = 0x089,
	MyTAGS_TAG_TFOOT          = 0x08a,
	MyTAGS_TAG_TH             = 0x08b,
	MyTAGS_TAG_THEAD          = 0x08c,
	MyTAGS_TAG_TIME           = 0x08d,
	MyTAGS_TAG_TITLE          = 0x08e,
	MyTAGS_TAG_TR             = 0x08f,
	MyTAGS_TAG_TRACK          = 0x090,
	MyTAGS_TAG_TT             = 0x091,
	MyTAGS_TAG_U              = 0x092,
	MyTAGS_TAG_UL             = 0x093,
	MyTAGS_TAG_VAR            = 0x094,
	MyTAGS_TAG_VIDEO          = 0x095,
	MyTAGS_TAG_WBR            = 0x096,
	MyTAGS_TAG_XMP            = 0x097,
	MyTAGS_TAG_FIRST_ENTRY    = MyTAGS_TAG__TEXT,
	MyTAGS_TAG_LAST_ENTRY     = 0x098
};
