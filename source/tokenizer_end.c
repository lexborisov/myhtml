...
{
    myhtml_tokenizer_queue_create_text_node_if_need(tree, qnode, html, html_size, MyHTML_TOKEN_TYPE_DATA);
    return html_offset;
}
...
size_t myhtml_tokenizer_end_state_tag_open(myhtml_tree_t* tree, mythread_queue_node_t* qnode, const char* html, size_t html_offset, size_t html_size)
{
    if(qnode->begin < html_size) {
        ...
        myhtml_check_tag_parser(tree, qnode, html);
...
{
    myhtml_tokenizer_queue_create_text_node_if_need(tree, qnode, html, html_size, MyHTML_TOKEN_TYPE_RCDATA);
    return html_offset;
}
...
{
    myhtml_tokenizer_queue_create_text_node_if_need(tree, qnode, html, html_size, MyHTML_TOKEN_TYPE_RAWTEXT);
    return html_offset;
}
...
{
    myhtml_tokenizer_queue_create_text_node_if_need(tree, qnode, html, html_size, MyHTML_TOKEN_TYPE_SCRIPT);
    return html_offset;
}
