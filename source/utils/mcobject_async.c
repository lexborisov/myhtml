...
void mcobject_async_test_nodes(mcobject_async_t *mcobj_async, size_t node_count)
{
    ...
    for(loop = 0; loop < to_count; loop++)
    {
        ...
        {
            mcobject_async_node_t* test_struct = (mcobject_async_node_t*)mcobject_async_malloc(mcobj_async, node_id, NULL);
...
{
    mcobject_async_t *mcobj_async = mcobject_async_create();
    mcobject_async_init(mcobj_async, 4096, 4096 * 6, sizeof(mcobject_async_node_t));
    
    mcobject_async_node_add(mcobj_async, NULL);
    mcobject_async_node_add(mcobj_async, NULL);
